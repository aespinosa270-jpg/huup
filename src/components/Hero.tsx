...
const waUrl = `https://wa.me/${WHATSAPP}?text=${encodeURIComponent(
  "Hola Huup, quiero cotizar mi plataforma."
)}`;
        ...
        <div className="flex flex-col items-start text-left">
          ...
          <h1 className="text-6xl font-extrabold tracking-tighter text-white md:text-8xl lg:text-[7rem] leading-[0.9]">
            ...
            <span className="block text-primary drop-shadow-[0_0_30px_rgba(255,77,0,0.3)]">
              <ScrambleText text="PROPIO." delay={0.6} />
            </span>
          </h1>
          ...
          >
            <span className="text-white/80 font-medium">Construimos tu e-commerce y tu ERP desde cero.</span> Sin licencias mensuales, sin comisiones por venta, sin depender de la plataforma de nadie. El software es un activo de tu empresa — no una renta que pagas cada mes.
          </motion.p>
          ...
          >
            <div>
              ...
              <p className="text-[10px] font-mono uppercase text-white/30 tracking-widest mt-1">Licencias / mes</p>
            </div>
            <div className="h-8 w-px bg-white/10" />
            <div>
              <p className="text-3xl font-bold text-white tracking-tight">100%</p>
              <p className="text-[10px] font-mono uppercase text-white/30 tracking-widest mt-1">Código del cliente</p>
            </div>
             <div className="h-8 w-px bg-white/10" />
          ...
          <div className="relative z-20 h-[600px] w-full rounded-2xl border border-white/10 bg-[#0A0A0A]/50 backdrop-blur-xl shadow-[0_0_100px_-20px_rgba(0,0,0,0.5)] overflow-hidden">
            ...
            <div className="p-6 relative h-full">
                ...
                <div className="mt-4 rounded-xl border border-white/5 bg-black/60 p-4 font-mono text-xs text-white/60 space-y-2 relative overflow-hidden">
                    ...
                    <p className="text-green-400">[SUCCESS] Next.js 16 Core Loaded</p>
