...
const TECHNOLOGIES = [
  { name: "Next.js 16", type: "FRAMEWORK", color: "text-white" },
  ...
  { name: "Tailwind CSS", type: "STYLING", color: "text-teal-400" },
  { name: "Node.js", type: "BACKEND", color: "text-emerald-400" },
  ...
  { name: "Redis", type: "CACHE", color: "text-red-400" },
